...
**Чего пока нет:** iOS, журнала событий, списка устройств покупателя, языков
кроме русского и английского. Версия начинается с нуля осознанно: до 1.0 API и
форматы могут меняться.
